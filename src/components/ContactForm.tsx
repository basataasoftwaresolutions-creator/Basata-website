  ...
  return (
    ...
    >
      ...
      hover:border-orange/50"
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="relative">
                      ...
                      <ChevronDown
                        ...
                        } top-1/2 transform -translate-y-1/2 w-5 h-5 text-muted-foreground pointer-events-none`}
                      />
                    </div>
                  </div>
                  ...
                  >
                    ...
                    <div className="space-y-4">
                      ...
                      <motion.div
                        whileHover={{ scale: 1.01 }}
                        onClick={() =>
                          handleInputChange("paymentMethod", "wallet")
                        }
                        className={`p-4 rounded-2xl border-2 cursor-pointer transition-all duration-300 ${
                        ...
                        >
                          ...
                          <div className="relative">
                            ...
                            <Lock
                              className={`absolute ${
                                language === "ar" ? "left-4" : "right-4"
                              } top-1/2 transform -translate-y-1/2 w-5 h-5 text-muted-foreground`}
                            />
                          </div>
                  ...
                  {emailStatus === "error" && (
                    <div className="p-4 rounded-2xl bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 text-red-600 dark:text-red-400 text-center">
                      {language === "ar"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
              {[
                ...
                return (
                  ...
                  >
                    <div
                      className="w-16 h-16 bg-gradient-to-br from-orange/20 to-orange/10 
