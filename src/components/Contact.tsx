...
const Contact = () => {
  ...
  return (
    <section className="flex items-center justify-center min-h-screen bg-[url('../public/contact.png')] bg-cover bg-center bg-no-repeat max-md:py-[100px] md:max-lg:px-10 px-3"  dir="ltr"
      style={{ direction: 'ltr' }}>
      <form className="bg-white dark:bg-form-dark-bg py-[60px] md:px-[24px] shadow-[2px_10px_28px_rgba(0,0,0,0.25)] w-full max-w-[1050px] max-md:px-3 rounded-[24px]">
